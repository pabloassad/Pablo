 ...
 * stacked lines, with the portrait plate tucked under the second line like a
 * Swiss affiche. Scroll compresses the composition (name drifts up, portrait
 * drifts against it) so the page feels like it folds under the nav. Static
  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] flex-col justify-between overflow-hidden pt-24 pb-6 sm:pt-28">
      ...
      <div className="relative mt-4 flex-1">
        {/* Portrait — right side, behind the type (desktop) */}
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ duration: 1.2, ease, delay: 0.55 }}
          style={reduced ? undefined : { y: plateY }}
          className="absolute right-4 top-[24%] z-0 hidden w-[30vw] max-w-[440px] md:block lg:right-8"
        >
          <figure>
