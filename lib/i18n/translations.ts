...
const fr: Translations = {
  ...
  work: {
    ...
    casesTitle: "Projets",
    casesIntro: "Le rôle, le contexte, les décisions, le résultat.",
    caseContext: "Contexte",
    caseChallenge: "Enjeu",
    caseDecisions: "Décisions",
    caseResult: "Résultat",
    caseRead: "Voir le projet",
...
const en: Translations = {
  ...
  work: {
    ...
    soundOff: "Mute",
    casesTitle: "Projects",
    casesIntro: "The role, the context, the decisions, the outcome.",
    caseContext: "Context",
    caseChallenge: "Challenge",
    caseDecisions: "Decisions",
    caseResult: "Outcome",
    caseRead: "View project",
